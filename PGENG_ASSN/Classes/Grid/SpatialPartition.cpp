...
//			if (!InRenderRange(distance) || !IsVisible(camera->GetCameraPos(), camera->GetCameraTarget() - camera->GetCameraPos(), i, j))
//			{
...
//            }  
//            theGrid[i * zNumOfGrid + j].CheckCollision(0.02);
//		}
//	}
//
...
//            float distance = CalculateDistanceSquare(&(camera->GetCameraPos()), i, j);
//
//            if (IsVisible(camera->GetCameraPos(), camera->GetCameraTarget() - camera->GetCameraPos(), i, j) && InRenderRange(distance))
//            {
//                modelStack.PushMatrix();
...
//}
//
//Grid* CSpatialPartition::GetGrid(const Vector3 position) const
//{
//    for (int i = 0; i < xNumOfGrid; i++)
//    {
//        for (int j = 0; j<zNumOfGrid; j++)
//        {
//            if (theGrid[i * zNumOfGrid + j].InGrid(position))
//                return &theGrid[i * zNumOfGrid + j];
//        }
//    }
//    return NULL;
//}
//
//Grid* CSpatialPartition::GetGrid(EntityBase* entity) const
//{
//    for (int i = 0; i < xNumOfGrid; i++)
//    {
//        for (int j = 0; j<zNumOfGrid; j++)
//        {
//            if (theGrid[i * zNumOfGrid + j].InGrid(entity))
//                return &theGrid[i * zNumOfGrid + j];
//        }
//    }
//    return NULL;
...
//Set Render range
//********************************************************************************/
//void CSpatialPartition::SetRenderRange(const float renderDistance)
//{
//	this->renderRange = renderDistance;
//}
//
///********************************************************************************
